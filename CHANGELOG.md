...
### Changed
- **Repo housekeeping**: removed stale Playwright `test-results*.json` artifacts from version control, cleaned up `.gitattributes` `export-ignore` rules, and added `CONTEXT.md` + `docs/adr/` (ADR records 0001–0003) to the repo.
...
### Changed
- Updated download links and documentation for v3.5.4 release.
- Bumped test badge from 182 to 213 passing tests.

## [3.5.3] - 2026-07-07

### Added
- Test coverage: background.js event wiring (onInstalled, alarm handlers, message
  handlers, storage.onChanged) and offscreen.js (mp3 playback, onended callbacks,
  message listener) — all coverage thresholds now met in CI.

## [3.5.2] - 2026-07-07

### Changed
- Version bump: signed release with GPG key for v3.5.2.

## [3.5.1] - 2026-06-30

### Changed
- Replaced AGENTS.md and .github/copilot-instructions.md with REASONIX.md for
